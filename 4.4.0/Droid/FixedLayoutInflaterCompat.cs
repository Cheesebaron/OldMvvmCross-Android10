...
namespace Droid
{
    public static class FixedLayoutInflaterCompat
    {
        ...
        private static void ForceSetFactory2(LayoutInflater inflater, LayoutInflater.IFactory2 factory)
        {
            if (!_checkedField)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("ForceSetFactory2 Could not find field 'mFactory2' on class {0}; inflation may have unexpected results.",
            ...
            if (_layoutInflaterFactory2Field != null)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("ForceSetFactory2 could not set the Factory2 on LayoutInflater {0} ; inflation may have unexpected results.", inflater);
                }
            }
        }
    }
