...
namespace Droid
{
    ...
    /// </summary>
    [Register("droid.FixedLayoutInflater")]
    public class FixedLayoutInflater : LayoutInflater
    {
        ...
        private const string Tag = "FixedLayoutInflater";
        ...
        public FixedLayoutInflater(Context context)
            : base(context)
        {
        ...
        public FixedLayoutInflater(LayoutInflater original, Context newContext, MvxBindingVisitor bindingVisitor, bool cloned)
        ...
        public FixedLayoutInflater(IntPtr handle, JniHandleOwnership transfer)
        ...
        {
            return new FixedLayoutInflater(this, newContext, _bindingVisitor, true);
        }
        ...
        {
            if (Debug)
                System.Diagnostics.Debug.WriteLine("{Tag} - ... OnCreateView 3 ... {name}", Tag, name);
        ...
        {
            if (Debug)
                System.Diagnostics.Debug.WriteLine("{Tag} - ... OnCreateView 4 ... {name}", Tag, name);
        ...
        {
            if (Debug)
                System.Diagnostics.Debug.WriteLine("{Tag} - ... PhoneLayoutInflaterOnCreateView ... {name}", Tag, name);
        ...
        public void setFactory(IFactory factory)
        {
            ...
            if (!(factory is FixedLayoutInflaterCompat.FactoryWrapper))
            {
                Factory =
                    new FixedLayoutInflaterCompat.FactoryWrapper(new DelegateFactory1(factory, _bindingVisitor));
                return;
            }
        ...
        {
            // Wrap the incoming factory if we need to.
            if (!(factory2 is FixedLayoutInflaterCompat.FactoryWrapper2))
            {
                Factory2 =
                    new FixedLayoutInflaterCompat.FactoryWrapper2(new DelegateFactory2(factory2, _bindingVisitor));
                return;
            }
            Factory2 = factory2;
        }
        ...
        private void SetupLayoutFactories(bool cloned)
        {
            ...
            if (Sdk > BuildVersionCodes.Honeycomb)
            {
                ...
                if (Factory2 != null && !(Factory2 is FixedLayoutInflaterCompat.FactoryWrapper2))
                {
                    FixedLayoutInflaterCompat.SetFactory(this, new DelegateFactory2(Factory2, _bindingVisitor));
                }
            ...
            if (Factory != null && !(Factory is FixedLayoutInflaterCompat.FactoryWrapper))
            {
                FixedLayoutInflaterCompat.SetFactory(this, new DelegateFactory1(Factory, _bindingVisitor));
            }
        }
        ...
        private void SetPrivateFactoryInternal()
        {
            ...
            if (setPrivateFactoryMethod != null)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Cannot invoke LayoutInflater.setPrivateFactory :\n{0}", ex.StackTrace);
                }
            }
        ...
        {
            if (Debug)
                System.Diagnostics.Debug.WriteLine("{Tag} - ... CreateCustomViewInternal ... {name}", Tag, name);
        ...
        protected IMvxAndroidViewFactory AndroidViewFactory
        {
            get
            {
                ...
                if (Mvx.TryResolve(out IMvxAndroidViewFactory viewFactory))
                {
        ...
        protected IMvxLayoutInflaterHolderFactoryFactory FactoryFactory
        {
            get
            {
                ...
                if (Mvx.TryResolve(out IMvxLayoutInflaterHolderFactoryFactory factoryFactory))
                {
        ...
        private class DelegateFactory2 : IMvxLayoutInflaterFactory
        {
            ...
            {
                if (Debug)
                    System.Diagnostics.Debug.WriteLine("{Tag} - ... OnCreateView ... {name}", Tag, name);
        ...
        private class PrivateFactoryWrapper2 : Object, IFactory2
        {
            ...
            private readonly MvxBindingVisitor _bindingVisitor;
            private readonly FixedLayoutInflater _inflater;

            internal PrivateFactoryWrapper2(IFactory2 factory2, FixedLayoutInflater inflater,
